...
type Propuesta struct {
	...
	Chosendn string  `protobuf:"bytes,9,opt,name=chosendn,proto3" json:"chosendn,omitempty"`
}
...
var file_chat_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x62, 0x6c, 0x65, 0x22, 0xb7, 0x01, 0x0a, 0x09, 0x50, 0x72, 0x6f, 0x70, 0x75, 0x65,
	...
	0x75, 0x6c, 0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x68, 0x6f, 0x73, 0x65, 0x6e, 0x64, 0x6e, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x68, 0x6f, 0x73, 0x65, 0x6e, 0x64, 0x6e, 0x22,
	...
	0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xf3, 0x07, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53,
	...
	,
...
var file_chat_proto_depIdxs = []int32{
	...
	0,  // 18: chat.ChatService.CambiarRA:input_type -> chat.Message
	0,  // 19: chat.ChatService.ConsultarRA:input_type -> chat.Message
	0,  // 20: chat.ChatService.SayHello:output_type -> chat.Message
	0,  // 21: chat.ChatService.SayHello2:output_type -> chat.Message
	0,  // 22: chat.ChatService.PedirConfirmacion:output_type -> chat.Message
	1,  // 23: chat.ChatService.GenerarPropuesta:output_type -> chat.Propuesta
	0,  // 24: chat.ChatService.Repartir:output_type -> chat.Message
	0,  // 25: chat.ChatService.SayHello3:output_type -> chat.Message
	0,  // 26: chat.ChatService.EscribirPropuesta:output_type -> chat.Message
	0,  // 27: chat.ChatService.HelperEscribirPropuesta:output_type -> chat.Message
	0,  // 28: chat.ChatService.AgregarTitulo:output_type -> chat.Message
	0,  // 29: chat.ChatService.HelperAgregarTitulo:output_type -> chat.Message
	2,  // 30: chat.ChatService.VerTitulos:output_type -> chat.Titulos
	2,  // 31: chat.ChatService.HelperVerTitulos:output_type -> chat.Titulos
	2,  // 32: chat.ChatService.ObtenerUbicaciones:output_type -> chat.Titulos
	0,  // 33: chat.ChatService.BuscarChunks:output_type -> chat.Message
	3,  // 34: chat.ChatService.HacerChunks:output_type -> chat.Response
	0,  // 35: chat.ChatService.Unir:output_type -> chat.Message
	1,  // 36: chat.ChatService.GenerarPropuesta2:output_type -> chat.Propuesta
	0,  // 37: chat.ChatService.PedirConfirmacion2:output_type -> chat.Message
	0,  // 38: chat.ChatService.CambiarRA:output_type -> chat.Message
	0,  // 39: chat.ChatService.ConsultarRA:output_type -> chat.Message
